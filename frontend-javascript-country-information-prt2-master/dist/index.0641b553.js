...
async function formSubmitHandler(event) {
    ...
    _utils.clearElement(formInputElement);
    _utils.clearElement(infoElement);
    _utils.clearElement(countryElement);
    _utils.setElementVisibility(countryElement, false);
    const country = await _api.getCountryByName(countryName);
    if (country) _utils.renderHTMLForCountry(country);
    else infoElement.innerHTML = `No results found for "${countryName}", please try again`;
}
async function app() {
    formElement.addEventListener("submit", formSubmitHandler);
    const countries = await _api.getAllCountriesSortedByName();
    if (countries) _utils.renderHTMLForCountries(countries);
}
app();

},{"./js/api":"9u7qN","./js/utils":"72Dku"}],"9u7qN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getCountryByName", ()=>getCountryByName);
parcelHelpers.export(exports, "getAllCountriesSortedByName", ()=>getAllCountriesSortedByName);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const API_BASE_URL = `https://restcountries.com/v2`;
async function getCountryByName(name) {
    try {
        const response = await (0, _axiosDefault.default).get(`${API_BASE_URL}/name/${name}?fullText=true`);
...
async function getAllCountriesSortedByName() {
    try {
        const response = await (0, _axiosDefault.default).get(`${API_BASE_URL}/all`);
        const countries = response.data;
...
var Buffer = require("19d855322d18c8a9").Buffer;
"use strict";
/**
...
},{"19d855322d18c8a9":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("16e8f08d9045e425");
var ieee754 = require("ff376716e4b39775");
...
},{"16e8f08d9045e425":"eIiSV","ff376716e4b39775":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderHTMLForCountries", ()=>renderHTMLForCountries);
/**
 ...
 */ parcelHelpers.export(exports, "renderHTMLForCountry", ()=>renderHTMLForCountry);
parcelHelpers.export(exports, "clearElement", ()=>clearElement);
parcelHelpers.export(exports, "setElementVisibility", ()=>setElementVisibility);
function renderHTMLForCountries(countries = {}) {
...
function renderHTMLForCountry(country) {
...
function setElementVisibility(element, isVisible = true) {
    if (isVisible) element.style.display = "block";
